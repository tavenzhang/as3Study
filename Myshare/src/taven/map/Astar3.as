package taven.map
{
	...
	public class Astar3
	{
		 ...
		 * 单例
		 */
		private static var _instance:Astar3;
		...
		private static function get instance():Astar3
		{
			if (_instance == null)
			{
				_instance=new Astar3();
			}
			return _instance;
		}
		 ...
		 * @param p_start		起点坐标
		 * @param p_end 		终点坐标
		 *isGridCaoody 是否已经是格子坐标 如果是不需要再 处理
