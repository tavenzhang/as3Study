package google.protobuf {
	...
	public dynamic final class ServiceOptions extends com.netease.protobuf.Message {
		 ...
		 *  @private
		 */
		public static const DEPRECATED:FieldDescriptor$TYPE_BOOL = new FieldDescriptor$TYPE_BOOL("google.protobuf.ServiceOptions.deprecated", "deprecated", (33 << 3) | com.netease.protobuf.WireType.VARINT);
		 ...
		 *  @private
		 */
		public static const UNINTERPRETED_OPTION:RepeatedFieldDescriptor$TYPE_MESSAGE = new RepeatedFieldDescriptor$TYPE_MESSAGE("google.protobuf.ServiceOptions.uninterpreted_option", "uninterpretedOption", (999 << 3) | com.netease.protobuf.WireType.LENGTH_DELIMITED, function():Class { return google.protobuf.UninterpretedOption; });
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 33:
					if (deprecated$count != 0) {
						throw new flash.errors.IOError('Bad data format: ServiceOptions.deprecated cannot be set twice.');
					}
					++deprecated$count;
