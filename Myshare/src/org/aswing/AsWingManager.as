...
public class AsWingManager{
     ...
     * @see org.aswing.RepaintManager#setAlwaysUseTimer()
     */
	 ...
	 * @throws org.aswing.error.AsWingManagerNotInited if checkError and both root and stage is null.
     * @see #setRoot()
     * @see #getStage()
     */ 
	 ...
	 * @return the stage.
	 * @throws org.aswing.error.AsWingManagerNotInited if checkError and stage is null.
	 * @see #initAsStandard()
	 * @see #setRoot()
	 */
