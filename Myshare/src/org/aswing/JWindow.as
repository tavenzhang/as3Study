...
public class JWindow extends JPopup{
	 ...
	 * @throws Error if the window has not a {@link org.aswing.JWindow} or <code>MovieClip</code> owner currently,
	 ...
	 * @see org.aswing.JPopup#getPopups()
	 */
	 ...
	 * @see org.aswing.JPopup#getOwnedPopupsWithOwner()
	 */
