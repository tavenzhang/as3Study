...
public class JScrollBar extends Component implements Orientable{
	 ...
	 * set the unit increment by the viewport, if it has one. The {@link org.aswing.Viewportable} interface
	 ...
	 * <p>
	 * The JScrollPane component creates scrollbars (by default) that then
	 * set the block increment by the viewport, if it has one. The {@link org.aswing.Viewportable} interface
	 ...
	 * @see org.aswing.BoundedRangeModel#getExtent()
	 */
	 ...
	 * @see org.aswing.BoundedRangeModel#setExtent()
	 */
	 ...
	 * @see org.aswing.BoundedRangeModel#setValueIsAdjusting()
	 */
